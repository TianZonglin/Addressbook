...
ArrayList<String> data = (ArrayList<String>)attribute.get("moreresult");
...
<%@ include file="../left.jsp"%>
    <div class="main"  >
      		...
      		<% if(data.size()==0){%>
      		     ...
      		     <div><span style="align:center;margin-top:10px;font-size:35"><h3>你要找的人去火星了</h3></span></div>
      				
      		<%}else{ %>		

      				<div><span class="pagetext"><h3>Current Information</h3></span></div>
