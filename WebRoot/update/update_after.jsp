...
ArrayList<String> data = (ArrayList<String>)attribute.get("uptdata");
ArrayList<String> mark = (ArrayList<String>)attribute.get("uptmark");
    ...
    <div class="main" >
         ...
         <table cellpadding="0" cellspacing="0" width="100%" align="center" class="tab1"  style="ord-break:break-all;word-wrap:break-word;margin-right:0px;margin-left:0px;"  >
				   ...
				   <tr style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" align="center" bgcolor="#CFEEF8">	
						...
						<td  class="tab1" style="width:12%"><h3>Update</h3></td>											       		  
				  </tr>
				       <%
				        int p = 0,cnt = 1;				    				        
		               ...
		               %>
		                   <%if(i%2!=0){ %><tr bgcolor="#CFEEF8">
			                   ...
			                   <%for(int j= 1;j<=6;j++){ %>
								...
								<td class="tab2" align="center"><a style="color:green;font-size:12px" onclick="doupdate('<%=mark.get(i)%>')" ><h3>修改</h3></a></td>  
							   </tr> 		                   
